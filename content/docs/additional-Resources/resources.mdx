...
<Tabs items={['Links']}>
  <Tab value="Links">
    - [HackTricks](https://book.hacktricks.xyz/): HackTricks is a educational Wiki that compiles knowledge about cyber-security.
    - [Payload All The Things](https://swisskyrepo.github.io/PayloadsAllTheThings/): A list of useful payloads and bypasses for Web Application Security. Feel free to improve with your payloads and techniques !
  </Tab>
</Tabs>
...
* [Amber](https://github.com/EgeBalci/amber) - Reflective PE packer for converting native PE files to position-independent shellcode.
...
* [Awesome Awesomeness](https://github.com/bayandin/awesome-awesomeness) - The List of the Lists.
